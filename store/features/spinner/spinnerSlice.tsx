...
import { Fixture, FixtureResponse } from "@/app/api/api-football/models/footballModels"
...
export const { setIsActiveSpinner, setIsInactiveSpinner } = spinnerSlice.actions
